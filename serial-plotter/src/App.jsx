...
import EnvrionmentSec from "./pages/Gpslatlong"
...
function App() {
 ...
 const [sensorData, setSensorData] = useState({
   ...
   gyro: { x: 0, y: 0, z: 0 },
   environment: {
     temperature: 25, // Example initial data
     humidity: 50,
     pressure: 1013,
     aqi: 30,
     altitude: 100, // Add the altitude field to match the data you're passing
   },
 })
  ...
  return (
    <Router>
      <Layout
        style={{ minHeight: "100vh", background: currentTheme.background }}
      >
        ...
        <Layout>
          ...
          >
            ...
            >
              ...
              <Menu.Item key="gas-concentration">
                <Link to="/gas-concentration">Gas-concentration</Link>
              </Menu.Item>
              <Menu.Item key="frequency">
                <Link to="/data-frequency">data-frequency</Link>
              </Menu.Item>
              <Menu.Item key="lat-long">
                <Link to="/lat-long">lat-long</Link>
              </Menu.Item>
            </Menu>
          </Sider>
